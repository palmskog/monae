...
Require Import monad monad_model proba_monad.
...
Let F : choiceType -> choiceType := (fun A : choiceType => [choiceType of necset (Dist_convType A)]).

(* we assume the existence of appropriate BIND and RET *)
Axiom BIND : forall (A B : choiceType) (m : F A) (f : A -> F B), F B.
Axiom RET : forall A : choiceType, A -> F A.
...
Program Let nepprob_mixin : MonadProb.mixin_of apmonad :=
  @MonadProb.Mixin apmonad (fun p (A : choiceType) (m1 m2 : F A) =>
